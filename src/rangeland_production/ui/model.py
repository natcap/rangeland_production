...
class AboutDialog(QtWidgets.QDialog):
    """Show a dialog describing the Rangeland Production Model.
    ...
    def __init__(self, parent=None):
        ...
        """
        QtWidgets.QDialog.__init__(self, parent=parent)
        self.setWindowTitle('About the Rangeland Production Model')
        self.setLayout(QtWidgets.QVBoxLayout())
        label_text = textwrap.dedent(
            """
            <h1>Rangeland Production Model</h1>
            <b>Version {version}</b> <br/> <br/>

            Documentation:
            <a href="http://viz.naturalcapitalproject.org/rangelands/about.html">
                        online</a><br/>
            Copyright 2019, The Natural Capital Project<br/>
            License:
            <a href="https://bitbucket.org/natcap/rangeland_production/src/tip/LICENSE.txt">
                        BSD 3-clause</a><br/>
            Project page:
            <a href="https://bitbucket.org/natcap/rangeland_production">
                        bitbucket.org/natcap/rangeland_production</a><br/>
...
class InVESTModel(QtWidgets.QMainWindow):
    ...
    def __init__(self, label, target, validator, localdoc,
        ...
        self.links.setText(' | '.join((
            'Rangeland Production Model %s' %
            rangeland_production.__version__, (
                '<a href="http://viz.naturalcapitalproject.org/rangelands/about.html">'
        ...
        self.help_menu.addAction(
            ...
            'About the Rangeland Production Model', self.about_dialog.exec_)
        self.help_menu.addAction(
    ...
    def save_to_python(self, filepath=None):
        ...
        # coding=UTF-8
        # -----------------------------------------------
        # Generated by Rangeland Production Model {model_version} on {today}
        ...
        with codecs.open(save_filepath, 'w', encoding='utf-8') as py_file:
            ...
            py_file.write(script_template.format(
                model_version=rangeland_production.__version__,
